...
struct ContentView: View {
    ...
    @State private var editingItem: SampleItem?
...
struct AddEditView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section("Recipient") {
                    TextField("Recipient", text: $title)
                        .accessibilityIdentifier("titleField")
                }
                Section("Kit value") {
                    TextField("Kit value", text: $amountText)
                        .keyboardType(.decimalPad)
                        .accessibilityIdentifier("amountField")
                }
                Section("Date sent") {
                    DatePicker("Date sent", selection: $date, displayedComponents: .date)
                }
                Section("Returned") {
            ...
            .navigationTitle(mode == .add ? "Add Sample" : "Edit Sample")
            .toolbar {
